...
<ul>
  ...
  <li><label><span>Interfaz:</span>
    <?= search_options('interfaz', (isset($_GET['interfaz_opts']) ? stripslashes($_GET['interfaz_opts']) : '')) ?></label>
    <input type="text" name="interfaz" value="<?= (isset($_GET['interfaz']) ? stripslashes($_GET['interfaz']) : '') ?>" /></li>

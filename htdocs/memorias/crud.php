...
if (isset($_GET['delete'])) {
	mysql_query("DELETE FROM `memorias` WHERE `id` = '$_GET[id]}'");
...
if (isset($_POST['submitted'])) {
	...
	$sql = "REPLACE INTO `memorias` (`id`, `ingreso`, `funciona`, `paso_test`, `capacidad`, `detalles`) VALUES ('$id', '$_POST[ingreso_year]-$_POST[ingreso_mth]-$_POST[ingreso_day]', '$_POST[funciona]', '$_POST[paso_test]', '$_POST[capacidad]', '$_POST[detalles]');";
...
print_header("NodoComunitario » Memorias » $action");

$row = mysql_fetch_array ( mysql_query("SELECT * FROM `memorias` WHERE `id` = '$id' "));
?>
